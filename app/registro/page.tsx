    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#2ECC71]/5 via-white to-[#2ECC71]/10 px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="card-surface p-8 sm:p-10">
            ...
            <div>
              ...
              <input
                ...
                className={`input-interactive ${
                  touchedFields.name && formErrors.name ? "border-[#EF4444]" : ""
                }`}
              ...
              {touchedFields.name && formErrors.name && (
                <p id="name-error" className="mt-2 text-sm text-[#EF4444] flex items-center gap-1.5 animate-scale-in">
          ...
          {/* Trial Info */}
          <div className="mt-6 p-4 bg-[#2ECC71]/5 border border-[#2ECC71]/20 rounded-xl">
            <div className="flex items-start gap-3">
              <i className="fas fa-gift text-[#2ECC71] text-lg mt-0.5"></i>
              <div>
